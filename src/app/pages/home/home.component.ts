...
export class HomeComponent {
  ...
  constructor() {
    this.pages = [
      ...
      { path: 'notes', title: 'Notes', iconSrc: 'https://cdn-icons-png.flaticon.com/128/2865/2865447.png' },
      { path: 'vaccines', title: 'Vaccins', iconSrc: 'https://cdn-icons-png.flaticon.com/128/1303/1303467.png' },
